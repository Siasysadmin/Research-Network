              ...
              {isMobileMenuOpen && (
                <div className="absolute right-0 mt-3 w-64 bg-[#16291e] border border-[#5bf9aa37] rounded-2xl shadow-2xl overflow-hidden z-50">
                  ...
                  <div className="p-2">
                    <button
                      onClick={() => handleNavigation(getProfilePath())}
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-slate-300 transition-colors text-sm"
                    >
                    ...
                    <button
                      onClick={handleLogout}
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-500/10 text-red-400 mt-1 transition-colors text-sm"
                    >
        ...
        <div className="flex md:hidden pb-3 w-full" ref={mobileSearchRef}>
          <div className="relative w-full">
            ...
            <input
              ...
              placeholder="Search users..."
              className="w-full pl-9 pr-4 py-2 bg-white/5 border border-[#5bf9aa20] focus:outline-none focus:ring-0 focus:border-[#32ff99] rounded-xl text-sm text-white placeholder-slate-500 transition-all"
            />
        ...
        >
          ...
          >
            ...
            <p className="text-slate-500 text-xs leading-relaxed mb-5">
              ...
              <span className="text-white font-medium">upload research</span>,
              and <span className="text-white font-medium">chat</span> with
              other users.
            </p>
