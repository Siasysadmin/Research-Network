    ...
    <div className="h-full w-full flex flex-col bg-white dark:bg-[#0d0f0e] rounded-3xl relative">
      <div className="flex-1 overflow-y-auto px-4 md:px-6 pt-5 md:pt-6 pb-6 hide-scrollbar">
        ...
        {userType === "individual" && (
          <AccordionSection id="professional" icon="school" title="Professional Information">
            ...
            <FieldInfo
              ...
              value={individualData.year_of_experience_vijay || individualData.year_of_experience}
            ...
            <FieldInfo
              ...
              value={individualData.previous_publication_vijay || individualData.previous_publication}
              icon="menu_book"
            />
        ...
        <AccordionSection id="contact" icon="contact_mail" title="Contact & Social">
          ...
          <LinkField
            label="Website"
            value={userType === "institute" ? instituteData.website : individualData.website}
          />
          <LinkField
            label="LinkedIn Profile"
            value={userType === "institute" ? instituteProfileData.linkedin : individualData.linkedin}
          />
          <LinkField
            label="ResearchGate Profile"
            value={userType === "institute" ? instituteProfileData.research_gate : individualData.research_gate}
          />
          <LinkField
            label="ORCID ID"
            value={userType === "institute" ? instituteProfileData.orc_id : individualData.orc_id}
          />
          <LinkField
