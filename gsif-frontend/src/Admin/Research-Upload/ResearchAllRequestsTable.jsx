...
const ResearchAllRequestsTable = ({
  requests = [],
  onViewDetails,
  currentPage = 1,
  totalPages = 1,
      ...
      <div className="overflow-auto flex-1" style={{ maxHeight: '600px' }}>
        <table className="w-full table-fixed">
          <thead className="sticky top-0 z-20 bg-[#0e1a14]">
            <tr className="bg-[#0e1a14] text-slate-400 text-xs uppercase">
            ...
            {requests.map((request) => {
              ...
              return (
                <tr key={id} className="hover:bg-[#1e3a2c]/30">
                  <td className="py-4 px-4 font-mono text-slate-400 truncate">
                    {registrationId}
                  </td>
                  ...
                  <td className="py-4 px-6 text-right">
                    <button
                      ...
                      className="px-3 py-1 bg-[#00ff88]/10 hover:bg-[#00ff88] text-[#00ff88] hover:text-black text-xs rounded transition-all duration-200"
                    >
                      VIEW DETAILS
                    </button>
                  </td>
...
export default ResearchAllRequestsTable;