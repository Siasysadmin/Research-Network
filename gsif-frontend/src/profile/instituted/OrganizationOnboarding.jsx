...
const OrganizationOnboarding = ({ onNext, progress }) => {
  ...
  return (
    <main
      className="
min-h-screen flex flex-col items-center py-16 px-4 md:px-0 font-sans

bg-white text-slate-900
dark:bg-[#10221a] text-slate-700 dark:text-white
"
    >
      {" "}
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              <input
                ...
                readOnly
                className="
w-full rounded-lg py-4 px-4 outline-none transition-colors duration-200 text-base

bg-gray-100 border border-gray-300 text-slate-900
dark:bg-slate-800/50 dark:border-white/15 dark:text-white
"
...
${
  orgType === option.id
    ? "border-[#00ff88] bg-green-50 dark:bg-[#1a2e25]"
    : "border-gray-300 bg-white hover:border-[#00ff88]/50 dark:border-[#31684e] dark:bg-[#1a2e25]"
}`}
                  >
                    {/* Custom Radio Button */}
