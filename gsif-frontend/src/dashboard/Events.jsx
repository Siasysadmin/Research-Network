...
<span className="material-symbols-outlined text-[12px] text-emerald-600 dark:text-[#32ff99]/60 shrink-0">              location_on
            </span>
            <span className="truncate">{location}</span>
          </div>
          <div className="flex items-center gap-1.5 text-[11px] text-slate-600 dark:text-slate-500">
<span className="material-symbols-outlined text-[12px] text-emerald-600 dark:text-[#32ff99]/60 shrink-0">              schedule
            </span>
            <span>
  ...
  className="
    ...
    dark:bg-[#00ff88]/10 dark:text-[#00ff88]
    border border-emerald-200 dark:border-[#00ff88]/20
  "
>
  {cat}
</span>
  ...
  className="w-full flex items-center justify-center gap-1.5 bg-[#32ff9915] hover:bg-[#32ff99] border border-[#32ff9930] hover:border-[#32ff99] text-[#1f9d63] dark:text-[#32ff9970] hover:text-black font-bold py-2 rounded-xl text-[11px] transition-all duration-200 group/btn"
>
