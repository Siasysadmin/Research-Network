...
import heroLightImg from "../assets/images/hero_light.png";
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <section className="relative min-h-screen overflow-hidden bg-white dark:bg-black">
        {/* TOP BAR */}
        <div className="absolute top-2 sm:top-4 left-2 sm:left-4 right-2 sm:right-4 flex justify-between items-center z-50 px-2 sm:px-4">
          {/* LOGO */}
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-slate-900 dark:text-white text-[10px] sm:text-xs md:text-sm font-bold tracking-[0.15em] sm:tracking-[0.25em]">
                RESEARCH
              </span>
              <span className="text-slate-900 dark:text-white text-[10px] sm:text-xs md:text-sm font-bold tracking-[0.15em] sm:tracking-[0.25em]">
                NETWORK
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-3 py-1.5 sm:px-5 sm:py-2 border-2 border-[#00FF88] text-[#00FF88] rounded-md font-semibold hover:bg-[#00FF88] hover:text-white dark:hover:text-black transition text-sm sm:text-base"
            >
              Login
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 lg:grid-cols-12 items-center min-h-screen">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 lg:space-y-8 mt-24 lg:mt-0 text-center lg:text-left z-20 relative">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black leading-tight">
              <span className="text-slate-900 dark:text-white">A Global Network for </span>
              <span className="text-[#00FF88]">Sustainability</span>{" "}
              <span className="text-slate-900 dark:text-white">Researchers & Institutions</span>
            </h1>

            <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base md:text-lg max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6 pt-2 sm:pt-4 justify-center lg:justify-start">
              <button
                ...
                className="px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 bg-[#00FF88] text-black font-bold rounded-lg hover:scale-105 transition text-sm sm:text-base shadow-lg shadow-primary/20"
              >
                Join as Individual
              </button>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end mt-12 lg:mt-0 relative z-10">
            ...
            <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] sm:w-[350px] lg:w-[450px] h-[250px] sm:h-[350px] lg:h-[450px] ${theme === 'dark' ? 'bg-[#00FF88]/20' : 'bg-[#00FF88]/10'} blur-[100px] rounded-full pointer-events-none transition-all duration-700`} />

            {/* The Image with faded edges using CSS Mask */}
            <img
              src={theme === "dark" ? heroDarkImg : heroLightImg}
              alt="GSIF Network"
              className="w-full max-w-[300px] sm:max-w-[400px] lg:max-w-[500px] object-contain relative z-10 pointer-events-none transition-all duration-700"
              style={{
      ...
      {/* ================= About SECTION ================= */}
      <section id="about" className="py-16 sm:py-20 md:py-24 lg:py-32 overflow-hidden bg-white dark:bg-black relative border-t border-slate-200 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 xl:gap-20 items-center">
            {/* Left Content */}
            <div className="space-y-8 lg:space-y-12">
              <div className="space-y-4 lg:space-y-6">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-tight text-center lg:text-left text-slate-900 dark:text-white">
                  About <span className="text-[#00FF88]">GSIF</span>{" "}
                  <span className="text-slate-900 dark:text-white">Research Network</span>
                </h2>

                <p className="text-slate-500 dark:text-slate-400 text-base sm:text-lg md:text-xl leading-relaxed text-center lg:text-left">
              ...
              <div className="grid grid-cols-1 gap-6 lg:gap-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 group text-center sm:text-left">
                  ...
                  <div className="space-y-1 sm:space-y-2">
                    <h4 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">Our Vision</h4>
                    <p className="text-slate-500 text-sm sm:text-base">
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <div className="relative p-1 bg-gradient-to-br from-[#00FF88]/30 to-transparent rounded-2xl sm:rounded-3xl">
                <div className="bg-white dark:bg-[#0a0a0a] rounded-xl sm:rounded-[1.4rem] p-6 sm:p-8 lg:p-12 space-y-6 lg:space-y-8 border border-slate-200 dark:border-white/5 transition-colors duration-300">
                  <div className="space-y-3 sm:space-y-4">
                    <span className="text-[#00FF88] font-bold uppercase tracking-widest text-xs sm:text-sm block text-center lg:text-left">
                      Our Impact
                    </span>
                    <h3 className="text-2xl sm:text-3xl font-bold leading-tight text-center lg:text-left text-slate-900 dark:text-white">
                      Where Research Drives Change
                    </h3>
                  </div>

                  <div className="space-y-4 sm:space-y-6">
                    <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed italic text-center lg:text-left">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed text-center lg:text-left">
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-slate-100/50 dark:bg-white/5 border-y border-slate-200 dark:border-white/5 relative overflow-hidden transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          {/* Heading */}
          <div className="text-center space-y-3 sm:space-y-4 mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight uppercase text-slate-900 dark:text-white">
              Who Can Join?
            </h2>
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 max-w-5xl mx-auto">
            ...
            <div className="group relative p-1 border-2 border-[#00FF88] rounded-[1.5rem] sm:rounded-[2rem] transition-all duration-500 hover:bg-gradient-to-br hover:from-[#00FF88]/40 hover:to-transparent">
              <div className="h-full bg-white dark:bg-black rounded-[1.4rem] sm:rounded-[1.85rem] p-6 sm:p-8 lg:p-10 flex flex-col items-center text-center space-y-4 sm:space-y-6 transition-all duration-500 group-hover:bg-slate-50 dark:group-hover:bg-black/90">
                ...
                <ul className="text-left text-slate-500 space-y-1.5 sm:space-y-2 text-xs sm:text-sm font-medium">
                  <li className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[#00FF88] text-sm font-bold">
                      check_circle
                    </span>
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-white dark:bg-black transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center space-y-3 sm:space-y-4 mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight uppercase text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className="p-6 sm:p-8 lg:p-10 rounded-2xl bg-white dark:bg-gradient-to-br dark:from-black dark:to-slate-900 border-2 border-slate-200 dark:border-[#00FF88]/50 shadow-sm dark:shadow-inner dark:shadow-[#00FF88]/20 transition-all neon-glow-hover group"
              >
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3 lg:mb-4 text-slate-900 dark:text-white">
                  {item.title}
                </h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                  {item.desc}
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-slate-100/50 dark:bg-white/5 border-y border-slate-200 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16 lg:mb-24">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6 text-slate-900 dark:text-white">
              How Research Moves Forward
            </h2>
            <p className="text-slate-500 dark:text-slate-400 text-base sm:text-lg md:text-xl leading-relaxed px-4">
          ...
          <div className="max-w-5xl mx-auto flex flex-col gap-8 sm:gap-12 lg:gap-16">
            {[
              ...
              >
                <div
                  className="p-6 sm:p-8 lg:p-12 rounded-2xl sm:rounded-3xl bg-white dark:bg-black 
  ...
  hover:shadow-[0_0_30px_rgba(0,255,163,0.35)]"
                >
                  ...
                  <div className="space-y-2 sm:space-y-3 lg:space-y-4 text-center md:text-left">
                    <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-slate-900 dark:text-white">
                      Step {item.step}: {item.title}
                    </h3>
                    <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed">
                      {item.desc}
                    </p>
                  </div>
                </div>
      ...
      {/* ================= FIELDS SECTION ================= */}
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-[#00FF88]/5 border-y border-[#00FF88]/10 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="space-y-10 lg:space-y-16">
            <div className="space-y-3 sm:space-y-4 lg:space-y-6 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-500 dark:text-slate-400 leading-relaxed max-w-4xl mx-auto lg:mx-0">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24 lg:py-32">
        <div className="rounded-2xl sm:rounded-3xl lg:rounded-[3rem] bg-gradient-to-br from-[#00FF88]/20 via-white dark:via-black to-slate-100 dark:to-black border border-slate-200 dark:border-[#00FF88]/20 p-6 sm:p-8 md:p-12 lg:p-24 text-center relative overflow-hidden transition-colors duration-300">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-6 sm:space-y-8 lg:space-y-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black leading-snug tracking-tight text-slate-900 dark:text-white">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 lg:gap-6 pt-2 sm:pt-3 lg:pt-4">
              {/* Buttons */}
              <button
                className="w-full sm:w-auto px-5 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-4 bg-[#00FF88] text-black font-bold rounded-lg hover:scale-105 transition text-sm sm:text-base shadow-lg shadow-primary/20"
                onClick={() => navigate("/individual")}
              >
                Join as Individual
              </button>
     ...
     {/* ================= FOOTER ================= */}
      <footer className="bg-white dark:bg-black border-t border-slate-200 dark:border-white/10 px-8 py-14 transition-colors duration-300">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex items-center gap-6 sm:gap-10 flex-wrap justify-center">
            <button
              ...
              className="text-slate-500 dark:text-slate-400 hover:text-[#00FF88] text-sm sm:text-base font-medium transition-colors"
            >
              About Us
            </button>
            <Link to="/privacy" className="text-slate-500 dark:text-slate-400 hover:text-[#00FF88] text-sm sm:text-base font-medium transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="text-slate-500 dark:text-slate-400 hover:text-[#00FF88] text-sm sm:text-base font-medium transition-colors">Terms & Conditions</Link>
            <span className="text-slate-500 dark:text-slate-400 text-sm sm:text-base font-medium">
              Contact: <span className="text-[#00FF88] font-semibold">research@gsif.org</span>
            </span>
          </div>

          {/* Divider */}
          <div className="w-full border-t border-slate-200 dark:border-white/10 pt-4">
